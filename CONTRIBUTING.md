...
midas-extract could always use more documentation, whether as part of the
official midas-extract docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
$ py.test tests.test_midas_extract
